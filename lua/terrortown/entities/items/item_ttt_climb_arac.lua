...
function ClimbRun(ply, _, _, noLag)
	if IsValid(ply) and ply:IsActive() and ply:HasEquipmentItem("item_ttt_climb") then
		noLag[1] = 1
	end
end
hook.Add("TTTPlayerSpeedModifier", "ClimbRunning", ClimbRun)
